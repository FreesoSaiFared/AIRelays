...
export async function handleRequest(request: Request, env: Env): Promise<Response> {
  ...
  if (url.pathname === '/readyz') return json({ status: 'ready', tools: TOTAL_TOOL_COUNT, upstreamTools: 144, sessionFarmTools: 12, deviceHubBound: !!env.DEVICE_HUB || !!env.FIXTURE_DISPATCH });
